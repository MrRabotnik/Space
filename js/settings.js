        ...
        const layerDiv =
            `<div class="layerSetting" id="${layer.id}">
                <div class="layerInfoContainer">
                    ...
                    <div class="layerSingleInfoContainer">Min radius <input class="layerSingleInfoInput" aria-id="${layer.id}" aria-property="minRadius" type="number" value="${layer.minRadius}"></div>
                    <div class="layerSingleInfoContainer">Max radius <input class="layerSingleInfoInput" aria-id="${layer.id}" aria-property="maxRadius" type="number" value="${layer.maxRadius}"></div>
                    <div class="layerSingleInfoContainer">Stars speed <input class="layerSingleInfoInput" aria-id="${layer.id}" aria-property="speed" type="number" value="${layer.speed}"></div>
